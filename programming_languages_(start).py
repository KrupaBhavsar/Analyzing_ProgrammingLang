...
Original file is located at
    https://colab.research.google.com/drive/1gtPPM66WjhkKFOnaPimqkC5y7ftq7tWY
...
# Assuming the column name is 'date_column' and the DataFrame is 'df'
df['m'] = pd.to_datetime(df['m']).dt.date
...
plt.xlabel('pivoted_df.java', fontsize=14)
plt.ylabel('pivoted_df.python', fontsize=14)
